...
contract StakeLPEarnMultiToken is Ownable, ERC20, ReentrancyGuard {
    ...
    constructor(IERC20 _lpToken) {
        ...
        pool.perSecond = 138888888888888900;
...
//            uint256 lpSupply = pool.lpToken.balanceOf(address(this));
    ...
    function setPerSecond(uint256 _perSecond) external onlyOwner {
        pool.perSecond = _perSecond;
    }

    function withdrawBase(uint256 idx) external onlyOwner {
        distributors[idx].withdraw(msg.sender);
    }
}
